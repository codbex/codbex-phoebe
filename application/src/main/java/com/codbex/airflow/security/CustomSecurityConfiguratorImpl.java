package com.codbex.airflow.security;

import com.codbex.airflow.proxy.AirflowProxyConfig;
...
@Component
class CustomSecurityConfiguratorImpl implements CustomSecurityConfigurator {
